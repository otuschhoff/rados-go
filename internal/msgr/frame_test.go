...
func TestCRCCodecDeterministicVectors(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			frame: oneSegment,
			wire:  "14010400000008000000000000000000000000000000000000000000c6329e8563657068ee24c1e0",
		},
		{
			name:  "disabled one segment",
			codec: CRCCodec{WithDataCRC: false},
			frame: oneSegment,
			wire:  "14010400000008000000000000000000000000000000000000000000c6329e856365706800000000",
		},
		{
			name:  "enabled multiple segments",
			codec: CRCCodec{WithDataCRC: true},
			frame: multiSegment,
			wire:  "11040600000008000000000008000600000008000400000000100000a46c0fbf686561646572bd1ea0e36d6964646c65000102030efffffffff29402775ce5cc26",
		},
		{
			name:  "disabled multiple segments",
			codec: CRCCodec{WithDataCRC: false},
			frame: multiSegment,
			wire:  "11040600000008000000000008000600000008000400000000100000a46c0fbf686561646572000000006d6964646c65000102030e000000000000000000000000",
		},
	}
